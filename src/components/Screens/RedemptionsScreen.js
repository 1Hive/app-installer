...
const RedemptionsScreen = React.forwardRef(function RedemptionsScreen(
  {
    appLabel,
    blurr,
    data,
            ...
            label={
              <React.Fragment>
                ...
                <Help hint="What are redeemable tokens?">
                  <strong>Redeemable tokens</strong> are ERC20 tokens that can
                  be redeemed in exchange for the organization's tokens. They
